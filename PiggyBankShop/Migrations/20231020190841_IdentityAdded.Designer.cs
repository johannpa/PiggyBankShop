...
namespace PiggyBankShop.Migrations
{
    ...
    [Migration("20231020190841_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PiggyBankShop.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PiggyBankShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PiggyBankShop.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PiggyBankShop.Models.OrderDetail", b =>
                {
                    b.HasOne("PiggyBankShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PiggyBankShop.Models.Product", "Product")
                        .WithMany()
